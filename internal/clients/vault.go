...
import (
	...
	"github.com/maxnovawind/provider-jet-vault/apis/v1alpha1"
)
...
type vaultCreds struct {
	...
	AuthLogin vaultAuthLogin `json:"auth_login"`
}
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		vaultCredsInstance := vaultCreds{}
		if err := json.Unmarshal(data, &vaultCredsInstance); err != nil {
			return ps, errors.Wrap(err, errUnmarshalCredentials)
		}
		log.Println(vaultCredsInstance)
		...
		ps.Configuration = map[string]interface{}{}
		ps.Configuration = map[string]interface{}{
			"address": vaultCredsInstance.Address,
			"auth_login": map[string]interface{}{
				"path": vaultCredsInstance.AuthLogin.Path,
				"parameters": map[string]interface{}{
					"role_id":   vaultCredsInstance.AuthLogin.Parameters.RoleID,
					"secret_id": vaultCredsInstance.AuthLogin.Parameters.SecretID,
				},
			},
		}
		return ps, nil
