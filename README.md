...
to the [latest release](https://github.com/maxnovawind/provider-jet-vault/releases):
```
...
You can see the API reference [here](https://doc.crds.dev/github.com/maxnovawind/provider-jet-vault).
...
open an [issue](https://github.com/maxnovawind/provider-jet-vault/issues).
